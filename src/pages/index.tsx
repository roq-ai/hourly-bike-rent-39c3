...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Hourly Bike Rental Application`}</title>

        <meta
          name="description"
          content="Hourly Bike Rental Application - Your Gateway to Flexible Hourly, Daily, Weekly, and Monthly Bike Rental Plans. Experience Freedom on Two Wheels."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1472709171579-139831cdf19e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiaWtlJTIwcmVudGFsfGVufDB8fHx8MTY5Nzc3NzE4N3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@overdriv3?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`A. L.`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Hourly Bike Rental Application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Hourly Bike Rental Application - Your Gateway to Flexible Hourly, Daily, Weekly, and Monthly Bike Rental Plans. Experience Freedom on Two Wheels.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                ...
                <Card userTypeName="End Customer" type="end-customer" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
