...
export function CompanyListPage(props: CompanyListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['description.contains', 'image.contains', 'bike_name.contains', 'name.contains'],
          ...params.filters,
        },
        'company',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'bike_id', header: 'Bike Id', accessorKey: 'bike_id' },
    { id: 'bike_name', header: 'Bike Name', accessorKey: 'bike_name' },
